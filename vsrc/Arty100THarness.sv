...
module Arty100THarness(
  ...
  output        ddr_ddr3_odt,
                ...
                led_14,
                led_15,
  input         wrapperio_interrupt,
                wrapperio_s_axi_arready,
  input  [31:0] wrapperio_s_axi_rdata,
  input         wrapperio_s_axi_rlast,
  input  [1:0]  wrapperio_s_axi_rresp,
  input         wrapperio_s_axi_rvalid,
                wrapperio_s_axi_awready,
  input  [1:0]  wrapperio_s_axi_bresp,
  input         wrapperio_s_axi_bvalid,
                wrapperio_s_axi_wready,
  output        wrapperio_clock_out,
                wrapperio_reset_out,
  output [31:0] wrapperio_s_axi_araddr,
  output [1:0]  wrapperio_s_axi_arburst,
  output [3:0]  wrapperio_s_axi_arcache,
  output [7:0]  wrapperio_s_axi_arlen,
  output [2:0]  wrapperio_s_axi_arprot,
                wrapperio_s_axi_arsize,
  output        wrapperio_s_axi_arvalid,
                wrapperio_s_axi_rready,
  output [31:0] wrapperio_s_axi_awaddr,
  output [1:0]  wrapperio_s_axi_awburst,
  output [3:0]  wrapperio_s_axi_awcache,
  output [7:0]  wrapperio_s_axi_awlen,
  output [2:0]  wrapperio_s_axi_awprot,
                wrapperio_s_axi_awsize,
  output        wrapperio_s_axi_awvalid,
                wrapperio_s_axi_bready,
  output [31:0] wrapperio_s_axi_wdata,
  output        wrapperio_s_axi_wlast,
  output [3:0]  wrapperio_s_axi_wstrb,
  output        wrapperio_s_axi_wvalid
);
  ...
  wire        _SerialWidthAdapter_io_narrow_in_ready;	// @[HarnessBinders.scala:33:42]
  wire        _SerialWidthAdapter_io_narrow_out_valid;	// @[HarnessBinders.scala:33:42]
  wire [7:0]  _SerialWidthAdapter_io_narrow_out_bits;	// @[HarnessBinders.scala:33:42]
  wire        _SerialWidthAdapter_io_wide_in_ready;	// @[HarnessBinders.scala:33:42]
  wire        _SerialWidthAdapter_io_wide_out_valid;	// @[HarnessBinders.scala:33:42]
  wire [31:0] _SerialWidthAdapter_io_wide_out_bits;	// @[HarnessBinders.scala:33:42]
  wire        _UARTToSerial_io_uart_txd;	// @[HarnessBinders.scala:31:36]
  wire        _UARTToSerial_io_serial_in_ready;	// @[HarnessBinders.scala:31:36]
  wire        _UARTToSerial_io_serial_out_valid;	// @[HarnessBinders.scala:31:36]
  wire [7:0]  _UARTToSerial_io_serial_out_bits;	// @[HarnessBinders.scala:31:36]
  ...
  wire [31:0] _in_queue_io_deq_bits;	// @[SerialAdapter.scala:34:28]
  wire        _out_queue_io_enq_ready;	// @[SerialAdapter.scala:28:29]
  wire        _out_queue_io_deq_valid;	// @[SerialAdapter.scala:28:29]
  wire [31:0] _out_queue_io_deq_bits;	// @[SerialAdapter.scala:28:29]
  ...
  always @(posedge _sys_clock_ibufg_O) begin	// @[ClockOverlay.scala:32:22]
    ...
    if (REG == 26'h0) begin	// @[Harness.scala:67:28, :70:21, :71:21]
      if (bundleIn_0_9)	// @[Harness.scala:69:60]
        REG_1 <= 2'h0;	// @[Harness.scala:68:23]
  ...
  UIntToAnalog_1 a2b (	// @[Util.scala:58:21]
    .a    (uart_txd),
    .b    (_UARTToSerial_io_uart_txd),	// @[HarnessBinders.scala:31:36]
  ...
  SerialRAM ram (	// @[SerialAdapter.scala:58:24]
    ...
    .io_tsi_ser_in_valid  (_SerialWidthAdapter_io_wide_out_valid),	// @[HarnessBinders.scala:33:42]
    .io_tsi_ser_in_bits   (_SerialWidthAdapter_io_wide_out_bits),	// @[HarnessBinders.scala:33:42]
    .io_tsi_ser_out_ready (_SerialWidthAdapter_io_wide_in_ready),	// @[HarnessBinders.scala:33:42]
  ...
  UARTToSerial UARTToSerial (	// @[HarnessBinders.scala:31:36]
    .clock               (_dutWrangler_auto_out_0_clock),	// @[Harness.scala:31:31]
    .reset               (_dutWrangler_auto_out_0_reset),	// @[Harness.scala:31:31]
    .io_uart_rxd         (_bundleIn_0_rxd_a2b_b),	// @[Util.scala:30:21]
    .io_serial_in_valid  (_SerialWidthAdapter_io_narrow_out_valid),	// @[HarnessBinders.scala:33:42]
    .io_serial_in_bits   (_SerialWidthAdapter_io_narrow_out_bits),	// @[HarnessBinders.scala:33:42]
    .io_serial_out_ready (_SerialWidthAdapter_io_narrow_in_ready),	// @[HarnessBinders.scala:33:42]
  ...
  SerialWidthAdapter SerialWidthAdapter (	// @[HarnessBinders.scala:33:42]
    .clock               (_dutWrangler_auto_out_0_clock),	// @[Harness.scala:31:31]
    .reset               (_dutWrangler_auto_out_0_reset),	// @[Harness.scala:31:31]
    .io_narrow_in_valid  (_UARTToSerial_io_serial_out_valid),	// @[HarnessBinders.scala:31:36]
    .io_narrow_in_bits   (_UARTToSerial_io_serial_out_bits),	// @[HarnessBinders.scala:31:36]
    .io_narrow_out_ready (_UARTToSerial_io_serial_in_ready),	// @[HarnessBinders.scala:31:36]
  ...
  assign led_0 = REG_1 == 2'h0;	// @[Harness.scala:68:23, :69:60]
  ...
  assign led_12 = _ram_io_adapter_state[0];	// @[HarnessBinders.scala:42:57, SerialAdapter.scala:58:24]
  assign led_13 = _ram_io_adapter_state[1];	// @[HarnessBinders.scala:43:58, SerialAdapter.scala:58:24]
  assign led_14 = _ram_io_adapter_state[2];	// @[HarnessBinders.scala:44:58, SerialAdapter.scala:58:24]
  assign led_15 = _ram_io_adapter_state[3];	// @[HarnessBinders.scala:45:58, SerialAdapter.scala:58:24]
endmodule
